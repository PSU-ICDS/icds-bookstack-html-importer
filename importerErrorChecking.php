...
class BookStack_Client {
 ...
 /** Kenny's Addition---
  * Why isn't this method included by default; nobody knows
...
/**
 * Kenny's Addition. This should help to delete 'glitched' books that are unable 
 * to be deleted through normal means
 * 
     * Deletes a book.
     *
